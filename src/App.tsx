...
function heroGradientValue(hero: BusinessConfig['hero']) {
  ...
  switch (style) {
    case 'aurora-mesh':
      return dark
        ? 'radial-gradient(circle at 15% 20%, rgba(99,102,241,.48), transparent 34%), radial-gradient(circle at 82% 28%, rgba(6,182,212,.38), transparent 32%), radial-gradient(circle at 50% 100%, rgba(16,185,129,.22), transparent 38%)'
        : 'radial-gradient(circle at 12% 18%, rgba(99,102,241,.26), transparent 32%), radial-gradient(circle at 86% 24%, rgba(6,182,212,.22), transparent 30%), radial-gradient(circle at 50% 100%, rgba(16,185,129,.14), transparent 38%)';
    case 'sunset-radiant':
      return dark
        ? 'radial-gradient(circle at 12% 15%, rgba(245,158,11,.42), transparent 34%), linear-gradient(135deg, #451a03 0%, #7c2d12 42%, #111827 100%)'
        : 'linear-gradient(135deg, #fff7ed 0%, #ffedd5 38%, #fee2e2 70%, #fff 100%)';
    case 'ocean-depth':
      return 'linear-gradient(135deg, #020617 0%, #0c4a6e 48%, #082f49 100%)';
    case 'emerald-nature':
      return dark
        ? 'radial-gradient(circle at 20% 15%, rgba(16,185,129,.38), transparent 34%), linear-gradient(135deg, #022c22 0%, #064e3b 48%, #0f172a 100%)'
        : 'linear-gradient(135deg, #ecfdf5 0%, #d1fae5 42%, #ccfbf1 72%, #fff 100%)';
    case 'dark-slate':
      return 'linear-gradient(135deg, #020617 0%, #0f172a 50%, #1e293b 100%)';
    case 'clean-subtle':
      return 'linear-gradient(135deg, #ffffff 0%, #f8fafc 48%, #e2e8f0 100%)';
    case 'brand-glow':
    default:
      return dark
        ? `radial-gradient(circle at 8% 15%, color-mix(in srgb, var(--color-primary) 42%, transparent), transparent 34%), radial-gradient(circle at 90% 20%, color-mix(in srgb, var(--color-accent) 32%, transparent), transparent 32%), linear-gradient(135deg, #020617 0%, #0f172a 100%)`
        : `radial-gradient(circle at 8% 15%, color-mix(in srgb, var(--color-primary) 18%, transparent), transparent 34%), radial-gradient(circle at 90% 20%, color-mix(in srgb, var(--color-accent) 16%, transparent), transparent 32%), linear-gradient(135deg, var(--color-background) 0%, #ffffff 100%)`;
  }
}
